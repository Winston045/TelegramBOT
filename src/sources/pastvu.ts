...
/**
 * Городов за один сбор. Чем больше городов и меньше фото с каждого, тем
 * разнообразнее партия: живой случай - три фото памятника Ленину из одной
 * точки Севастополя в одном резерве при трёх городах по 15 снимков.
 */
const CITIES_PER_FETCH = 5;
