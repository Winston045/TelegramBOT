...
Цитата - познавательная часть поста: читатель не знает, что за момент
на снимке, и должен узнать новое. Аудитория канала разбирается в военной
истории: базовые вещи (кто с кем воевал, когда шла война) она знает.
Цитата хорошая, если знающий читатель узнал из неё что-то новое:
