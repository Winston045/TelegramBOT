...
Если цитата плохая, реши, чем её заменить:
...
Верни строго JSON без обёрток, ровно одну из двух форм:
- цитата хорошая (место-год ИЛИ настоящая изюминка): {"verdict": "ok"}
- цитата плохая: {"verdict": "weak", "quote": "...", "quote_kind": "observation" | "context"}`;
}
