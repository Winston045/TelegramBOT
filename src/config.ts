...
export type AppConfig = {
  ...
  collect: {
    ...
    min_score?: number;
    /**
     * Статика (action: false) проходит в резерв только с такой оценкой.
     * Канал держится на действии; позирование и построения нужны лишь
     * тогда, когда кадр исключителен сам по себе.
     */
    static_min_score?: number;
  };
  publish: {
    times: string[];
    timezone: string;
